...
Route::resource('contact', ContactController::class)->withoutMiddleware(['is_admin']);
...
Route::group(['middleware' => ['is_admin']], function() {
    ...
    Route::get('front/questions',[FrontQuestionController::class,'questions'])->withoutMiddleware(['is_admin']);
