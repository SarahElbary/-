...
<head>
    ...
    <title> بريست كانسر | Breast Cancer </title>
    <!--font--->
                ...
                <div class="col-lg-8">
                    ...
                    <div class="img-header-left">
                        <ul class="nav justify-content-Start">
                            ...
                            <li class="nav-item">
                                <a class=" nav-link" href="{{ asset('front/questions') }}">الأسئلة الشائعة</a>
                            </li>
                            ...
                            @endforeach
                            <li class="nav-item">
                                <a class=" nav-link" href="{{ asset('call') }}">اتصلي بنا</a>
                            </li>
                        </ul>
                    </div>
                    <!--=================================================-->
                        ...
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item dropdown">
                                <a style="color: white" id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    مرحباً  {{ Auth::user()->name }}  <span class="caret"></span>
                                </a>
